...
namespace PriSecDBClientPanel
{
    public partial class RenewPayment : Form
    {
        ...
        public Boolean RemainKeysVerifyPayment(String OrderID, Byte[] RandomChallenge)
        {
            String UniquePaymentID = "";
            Byte[] UniquePaymentIDByte = new Byte[] { };
            Byte[] CipheredUniquePaymentIDByte = new Byte[] { };
            ...
            if (OrderID != null && OrderID.CompareTo("") != 0)
            {
                if (ETLSSessionID != null && ETLSSessionID.CompareTo("") != 0)
                {
                    ...
                    SealedDHED25519SK = File.ReadAllBytes(Application.StartupPath + "\\Application_Data\\" + "SignatureStorage\\SignatureSealedDHED25519SK.txt");
                    SealedDHED25519PK = File.ReadAllBytes(Application.StartupPath + "\\Application_Data\\" + "SignatureStorage\\SignatureSealedDHED25519PK.txt");
                    IKDHED25519SK = File.ReadAllBytes(Application.StartupPath + "\\Application_Data\\" + "SignatureStorage\\IKSignatureED25519SK.txt");
                    IKDHED25519PK = File.ReadAllBytes(Application.StartupPath + "\\Application_Data\\" + "SignatureStorage\\IKSignatureED25519PK.txt");
                    SPKDHED25519SK = File.ReadAllBytes(Application.StartupPath + "\\Application_Data\\" + "SignatureStorage\\SPKSignatureED25519SK.txt");
                    SPKDHED25519PK = File.ReadAllBytes(Application.StartupPath + "\\Application_Data\\" + "SignatureStorage\\SPKSignatureED25519PK.txt");
                    OPKDHED25519SK = File.ReadAllBytes(Application.StartupPath + "\\Application_Data\\" + "SignatureStorage\\OPKSignatureED25519SK.txt");
                    OPKDHED25519PK = File.ReadAllBytes(Application.StartupPath + "\\Application_Data\\" + "SignatureStorage\\OPKSignatureED25519PK.txt");
                    SealedDHX25519SK = File.ReadAllBytes(Application.StartupPath + "\\Application_Data\\" + "DHStorage\\SealedDHX25519SK.txt");
                    SealedDHX25519PK = File.ReadAllBytes(Application.StartupPath + "\\Application_Data\\" + "DHStorage\\SealedDHX25519PK.txt");
                    IKX25519SK = File.ReadAllBytes(Application.StartupPath + "\\Application_Data\\" + "DHStorage\\IKX25519SK.txt");
                    IKX25519PK = File.ReadAllBytes(Application.StartupPath + "\\Application_Data\\" + "DHStorage\\IKX25519PK.txt");
                    SPKX25519SK = File.ReadAllBytes(Application.StartupPath + "\\Application_Data\\" + "DHStorage\\SPKX25519SK.txt");
                    SPKX25519PK = File.ReadAllBytes(Application.StartupPath + "\\Application_Data\\" + "DHStorage\\SPKX25519PK.txt");
                    OPKX25519SK = File.ReadAllBytes(Application.StartupPath + "\\Application_Data\\" + "DHStorage\\OPKX25519SK.txt");
                    OPKX25519PK = File.ReadAllBytes(Application.StartupPath + "\\Application_Data\\" + "DHStorage\\OPKX25519PK.txt");
                    SharedSecret = File.ReadAllBytes(Application.StartupPath + "\\Temp_Session\\" + ETLSSessionID + "\\" + "SharedSecret.txt");
                    ClientED25519SK = File.ReadAllBytes(Application.StartupPath + "\\Temp_Session\\" + ETLSSessionID + "\\" + "ECDSASK.txt");
                    NonceByte = SodiumSecretBox.GenerateNonce();
                    UniquePaymentID = File.ReadAllText(Application.StartupPath + "\\Application_Data\\" + "DBCredentials\\PaymentID.txt");
        ...
        private void VerifyPaymentBTN_Click(object sender, EventArgs e)
        {
            ...
            if(OrderIDTB.Text!=null && OrderIDTB.Text.CompareTo("") != 0) 
            {
                ...
                if (DecisionCB.Checked == true) 
                {
                    HasMadePayment = RemainKeysVerifyPayment(OrderID, RandomChallengeByte);
                }
                else 
                {
                    HasMadePayment = VerifyPayment(OrderID, RandomChallengeByte);
                }                
                if (HasMadePayment == true && DecisionCB.Checked==false) 
                {
                ...
                else if(HasMadePayment==true && DecisionCB.Checked == true) 
                {
                    MessageBox.Show("Congratulations, you have renew payment, all cryptographic keys have been updated but remain the same",
                        "Congratulation", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else 
                {
