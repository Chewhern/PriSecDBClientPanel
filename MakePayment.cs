                            ...
                            if (result.IsSuccessStatusCode)
                            {
                                ...
                                else
                                {
                                    ...
                                    if (MyModel.Status != null && MyModel.Status.CompareTo("") != 0)
                                    {
                                        ...
                                        ClientX25519SK = File.ReadAllBytes(Application.StartupPath + "\\Temp_Session\\" + ETLSSessionID + "\\" + "ECDHSK.txt");
                                        DatabaseUserPasswordByte = SodiumSealedPublicKeyBox.Open(EncryptedDatabaseUserPasswordByte, ClientX25519PK, ClientX25519SK);
                                        ...
                                        MyGeneralGCHandle = GCHandle.Alloc(ClientX25519SK, GCHandleType.Pinned);
                                        SodiumSecureMemory.MemZero(MyGeneralGCHandle.AddrOfPinnedObject(), ClientX25519SK.Length);
                                    ...
                                    {
                                        MyGeneralGCHandle = GCHandle.Alloc(ClientED25519SK, GCHandleType.Pinned);
                                        SodiumSecureMemory.MemZero(MyGeneralGCHandle.AddrOfPinnedObject(), ClientED25519SK.Length);
                                        MyGeneralGCHandle.Free();
                                        MyGeneralGCHandle = GCHandle.Alloc(ClientX25519SK, GCHandleType.Pinned);
                                        SodiumSecureMemory.MemZero(MyGeneralGCHandle.AddrOfPinnedObject(), ClientX25519SK.Length);
                                        MyGeneralGCHandle.Free();
